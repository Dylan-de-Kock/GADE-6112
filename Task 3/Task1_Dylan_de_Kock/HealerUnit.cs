...
{
    //a unit that heals their teammates when close enough
    class HealerUnit : Unit
    {
        ...
        public HealerUnit(int x, int y, int health, int speed, int attack, int range, bool team, string symbol, string name)
        ...
        public override bool moveTowards(string direction, string[,] map)
        {
            ...
            if (direction == "NE")
            {
                ...
                {
                    if (map[this.x + i, this.y - i].Equals(" * "))
                    {
                        x += i;
                        y -= i; 
                    }
        ...
        public override void save()
        {
            try
            {
                FileStream outFileHealer = new FileStream(@"Files\\HealerUnit.txt", FileMode.Append, FileAccess.Write);
                StreamWriter writer = new StreamWriter(outFileHealer);
